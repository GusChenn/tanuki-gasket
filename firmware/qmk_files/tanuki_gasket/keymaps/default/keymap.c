...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_DL] = LAYOUT(
        ...
        KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, TG(_GLV), KC_TRNS, KC_PSCR, KC_TRNS,
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
    ...
    [_GLV] =
        LAYOUT(KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0,
               KC_ESC, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O,
               KC_P, KC_BSPC, KC_TAB, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J,
               KC_K, KC_L, KC_SCLN, TG(_GLV), KC_LSFT, KC_Z, KC_X, KC_C, KC_V,
               KC_B, KC_N, KC_M, KC_QUOT, KC_SLSH, KC_ENT, KC_LCTL, KC_LALT,
               KC_COMMA, KC_SPC, KC_SPC, KC_DOT, KC_LGUI)};
